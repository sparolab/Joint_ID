...
class Joint_UW_Enhancement_Evaluator(object):
    def __init__(self,  
                 device,
                 dataloader_eval,
                 ngpus:int=0,
        ...
        self.eval_metrics = ['uw_abs_rel', 'uw_rms', 'uw_sq_rel', 'uw_psnr']
        ...
        self.best_eval_steps = np.zeros(self.metrics_len, dtype= np.int32)
    ...
    def enhancement_compute_errors(self, gt, pred):
        ...
        return [abs_rel, rms, sq_rel, psnr]
