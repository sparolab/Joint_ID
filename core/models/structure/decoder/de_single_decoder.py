...
class De_Joint_ID_Head(nn.Module):
    ...
    def __init__(self, img_size, in_channels, embed_dim, num_classes, depths, use_norm=True, up_ratio=4, **kwargs):
        ...
        self.init_depth = nn.Sequential(nn.Conv2d(in_channels=c4_in_channels, out_channels=c4_in_channels, kernel_size=3, padding=1),
    ...
    def forward(self, inputs):
        ...
        x = self.init_act_layer(self.init_depth(c4))
...
@DECODER.register_module()
class joint_de_single_head(De_Joint_ID_Head):
    def __init__(self, **kwargs):
        super(joint_de_single_head, self).__init__(**kwargs,
